...
try {
  ...
  console.log(JSON.stringify({result:'PASS',origin,transport:base.startsWith('https:')?'HTTPS':'private-loopback',checks:['anonymous denial','secure role sessions','cross-origin denial','source routes not exposed','merchant/promoter isolation','wallet signature domain','preserved Fuji receipt','logout invalidation'],newPayments:0},null,2));
